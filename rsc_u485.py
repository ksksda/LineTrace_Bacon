...
#        print self.ser.portstr
    def b3m_test(self):
        ...
        sendbuf.append(0xFF) #3 OP
        sendbuf.append(0x00) #4 ID
    ...
    def Dyna(self):
        sendbuf = []
        #パケット作成
        sendbuf.append(0xFF) #1 Header ヘッダー1
        sendbuf.append(0xFF) #2 Header ヘッダー2
        sendbuf.append(0xFE) #3 ID     サーボID  0x00
        sendbuf.append(0x04) #4 Length
        sendbuf.append(0x03) #5 INST instruction
        sendbuf.append(0x19) #6 Address
        sendbuf.append(0x01) #7
    ...
    def BauChange(self):
        sendbuf = []
        #パケット作成
        sendbuf.append(0xFA) #1 Header ヘッダー1
        sendbuf.append(0xAF) #2 Header ヘッダー2
        sendbuf.append(0xFF)  #3 ID     サーボID  0x00
        sendbuf.append(0x00) #4 Flags  フラグ
        sendbuf.append(0x06) #5 Addressアドレス4=ID(0x1E=30)
        sendbuf.append(0x01) #6 Length 長さ(4byte)
        sendbuf.append(0x01) #7 Count  個数
        sendbuf.append(0x0A) #8
        # チェックサムの計算
        sum = sendbuf[2]
    ...
    def ServoReboot(self):
        sendbuf = []
        #パケット作成
        sendbuf.append(0xFA) #1 Header ヘッダー1
        sendbuf.append(0xAF) #2 Header ヘッダー2
        sendbuf.append(0xFF)  #3 ID     サーボID  0x00
        sendbuf.append(0x20) #4 Flags  フラグ
        sendbuf.append(0xFF) #5 Addressアドレス4=ID(0x1E=30)
        sendbuf.append(0x00) #6 Length 長さ(4byte)
        sendbuf.append(0x00) #7 Count  個数
        # チェックサムの計算
        sum = sendbuf[2]
    ...
    def RomSave(self):
        ...
        sendbuf.append(0xFA) #1 Header ヘッダー1
        sendbuf.append(0xAF) #2 Header ヘッダー2
        sendbuf.append(0xFF)  #3 ID     サーボID
        sendbuf.append(0x40) #4 Flags  フラグ
        sendbuf.append(0xFF) #5 Addressアドレス4=ID(0x1E=30)
        sendbuf.append(0x00) #6 Length 長さ(4byte)
        sendbuf.append(0x00) #7 Count  個数
        # チェックサムの計算
    ...
    def IDchange(self,cId):
        ...
        sendbuf.append(0xFF)  #3 ID     サーボID  0x00
        sendbuf.append(0x00) #4 Flags  フラグ
        sendbuf.append(0x04) #5 Addressアドレス4=ID(0x1E=30)
        sendbuf.append(0x01) #6 Length 長さ(4byte)
        sendbuf.append(0x01) #7 Count  個数
        sendbuf.append((cId&0x00FF)) #8
        # チェックサムの計算
        sum = sendbuf[2]
    ...
    def move(self,sId,sPos,sTime):
       ...
       指定時間の単位は10ms単位(最大0.5%の誤差)
        ...
        sendbuf.append((sId&0xFF))#sId) # サーボID
